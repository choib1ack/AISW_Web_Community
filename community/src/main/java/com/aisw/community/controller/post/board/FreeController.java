...
@Slf4j
@RestController
public class FreeController implements CrudInterface<FreeApiRequest, FreeApiResponse> {

    @Autowired(required = false)
    protected BoardPostService<FreeApiRequest, FileUploadToFreeRequest, BoardResponseDTO, FreeDetailApiResponse, FreeApiResponse, Free> boardPostService;
