...
-- Table `aisw`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aisw`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `email` VARCHAR(45) NOT NULL,
  `phone_number` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `aisw`.`site_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aisw`.`site_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `aisw`.`site_information` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_site_information_site_category1`
    FOREIGN KEY (`site_category_id`)
    REFERENCES `aisw`.`site_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
